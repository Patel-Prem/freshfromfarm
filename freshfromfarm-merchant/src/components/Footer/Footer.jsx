...
export default function Footer() {
  return (
    <footer className="bg-background border-t border-gray-200 dark:border-gray-700/60">
      <div className="mx-auto px-4 pt-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <form className="mt-4 flex flex-col md:flex-row">
              <input
                ...
                required
                type="text"
                className="mb-3 h-12 w-full flex-grow rounded border border-gray-300 bg-white px-4 shadow-sm transition duration-200 focus:outline-none md:mb-0 md:mr-2"
              />
              <Button
                onClick={() => navigate("/login")}
                variant="primary"
                size="sm"
                className="min-h-10 px-8 rounded-md"
              >
                Subscribe
              </Button>
            </form>
        ...
        <div className="flex flex-col justify-between border-t border-gray-800 pb-10 pt-5 sm:flex-row">
          ...
          {/* <div className="mt-4 flex items-center space-x-4 sm:mt-0">
            <NavLink
              to="/"
              className="hover:text-teal-accent-400 text-gray-100 transition-colors duration-300"
            >
